 ...
 function Address(props) {
    ...
    console.log("Address",orderDetails)
        ...
        if (token != ''){
            useEffect(() => 
            {
                axios.get(`http://localhost:5000/users/baggetall/${token}`)
                .then(res =>
                    {
            ...
            return window.location ="./login"
                ...
                if (token != ''){
                    useEffect(() => 
                    {
                        ...
                        axios.get(`http://localhost:5000/users/getAddress`,requestOptions)
                        .then(res =>
                            {
                                console.log(res.data.data);
      ...
      if (token != ''){
        useEffect(() => {
            axios
            .put(`http://localhost:5000/users/updateAddress`,updateAddress)
            .then(res =>{
        ...
        useEffect(() => { 
            ...
            axios.post(`http://localhost:5000/users/Address/${token}`,newAddress )
       ...
       useEffect(() =>{
        ...
        fetch('http://localhost:5000/users/delAddress',requestOptions).then(res=>{
...
//--------------------Order Post----------------------------------
      useEffect(() => { 
        axios .post(`http://localhost:5000/users/createOrder`,orderDetails )
